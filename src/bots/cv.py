...
async def handle_photo(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    try:
        ...
        logger.info(f"Processing image from URL: {photo_url}")

        await processing_message.edit_text("📥 Image received! Sending to Azure...")

        # Call Azure's OCR service
        read_response = computervision_client.read(photo_url, raw=True, language='pt')
